...
public class Vector3Dynamics : SecondOrderDynamicsBase<Vector3>
{
	public Vector3Dynamics(float f, float z, float r, Vector3 x0)
		: base(f, z, r, x0)
	{
	}

	public Vector3Dynamics(Vector3 x0)
		: base(x0)
	{
	}

	public Vector3Dynamics(DynamicsParameters parameters, Vector3 x0)
		: base(parameters, x0)
	{
	}
