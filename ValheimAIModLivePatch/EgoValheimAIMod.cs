...
namespace EgoValheimAIMod
{
    ...
    public class ValheimAIModLivePatch : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            GameObject HumanoidNPCPrefab = script_npc_assetBundle.LoadAsset<GameObject>("Assets/CustomAssets/HumanoidNPC.prefab");
        ...
        {
            NPCScript npcscript_component = IsScriptNPC(__instance.m_character);
        ...
        private void StartPatrol(Player player)
        {
            ...
            {
                MonsterAI monsterAIcomponent = npc.GetComponent<MonsterAI>();
                HumanoidNPC humanoidNPC_component = npc.GetComponent<HumanoidNPC>();
